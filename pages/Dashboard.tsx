            ...
            <div className="space-y-3">
                {myTasks.map(task => (
                    <div 
                        ...
                        className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 relative overflow-hidden cursor-pointer active:scale-[0.98] transition-transform"
                    >
                        ...
                        {/* Title */}
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1 leading-tight line-clamp-1">
                            {task.title}
                        </h3>
